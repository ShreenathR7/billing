...
class Test_Logimax:
    ...
    def test_Billing_DebitCard(self,booting_function):   
        ...
        sleep(5)
        self.driver.find_element(by=By.ID,value=locators.Logi_Locators().debit_card).click()      
        sleep(5)
        self.driver.find_element(by=By.ID,value=locators.Logi_Locators().Add_debit_card).click()
        sleep(5)
        ...
        assert self.driver.title == 'Logimax Technology | Admin'
        print("Estimation number : 8  Billing successfully completed payment Debit Card")
